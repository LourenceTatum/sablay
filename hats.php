...
<body>
    ...
    <main class="catalog-section">
        ...
        <div class="product-filters">
            <a href="hats.html" class="filter-button current-filter">HATS</a>
            <a href="leather.html" class="filter-button">LEATHER</a>
        </div>

        <div class="jewelry-grid">
            <div class="jewelry-card" data-name="Chomper Cap" data-price="60">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/chomper.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Chomper Cap</h3>
                    <p class="item-price">USD 60</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Tripple Cross" data-price="45">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/tcap.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Tripple Cross Cap</h3>
                    <p class="item-price">USD 45</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="hollywood USA" data-price="75">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/hollywood.jpg" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Hollywood USA Cap</h3>
