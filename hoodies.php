...
<body>
    ...
    <main class="catalog-section">
        ...
        <div class="product-filters">
            <a href="hoodies.html" class="filter-button current-filter">HOODIES</a>
            <a href="tees.html" class="filter-button">TEES</a>
        </div>

        <div class="jewelry-grid">
            <div class="jewelry-card" data-name="Multicolor Cross" data-price="150">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/multicolor.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Multicolor Hoodie</h3>
                    <p class="item-price">USD 150</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Horseshoe" data-price="185">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/horseshoe.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Horseshoe Logo Hoodi</h3>
                    <p class="item-price">USD 185</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="American Flag" data-price="165">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/american.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts American Flag Hoodie</h3>
                    <p class="item-price">USD 165</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
        </div>
