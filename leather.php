...
<head>
    ...
    <title>LEATHER GOODS - RENCEHART</title>
...
<body>
    <header class="main-header">
        <nav class="nav-menu">
            ...
            <a href="accessories.html" class="nav-link current-page">ACCESSORIES</a>
        </nav>
    ...
    <main class="catalog-section">
        ...
        <div class="product-filters">
            <a href="hats.html" class="filter-button">HATS</a>
            <a href="leather.html" class="filter-button current-filter">LEATHER</a>
        </div>

        <div class="jewelry-grid">
            <div class="jewelry-card" data-name="Leather Wallet" data-price="120">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/trifold.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Black Leather Trifold Wallet</h3>
                    <p class="item-price">USD 120</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Leather Bag" data-price="180">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/xlarge.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Extra Large Dagger Leather Shoulder Bag</h3>
                    <p class="item-price">USD 180</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Leather Belt" data-price="75">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/belt.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Oval Cross Belt Leather</h3>
                    <p class="item-price">USD 75</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
        </div>
