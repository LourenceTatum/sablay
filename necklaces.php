...
<head>
    ...
    <title>NECKLACES - RENCEHART</title>
...
<body>
    ...
    <main class="catalog-section">
        ...
        <div class="product-filters">
            ...
            <a href="necklaces.html" class="filter-button current-filter">NECKLACES</a>
            <a href="bracelet.html" class="filter-button">BRACELETS</a>
        </div>

        <div class="jewelry-grid">
            <div class="jewelry-card" data-name="Dagger necklace" data-price="1250">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/dagger.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Dagger Necklace<h3>
                    <p class="item-price">USD 1,250</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Sterling Couples" data-price="1800">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/sterling_couples.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Sterling Couple Necklace</h3>
                    <p class="item-price">USD 1,800</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Tripple Cross" data-price="1450">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/tripple.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Tripple Cross Necklace</h3>
                    <p class="item-price">USD 1,450</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
        </div>
