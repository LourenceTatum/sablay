...
<body>
    ...
    <main class="catalog-section">
        ...
        <div class="product-filters">
            <a href="rings.html" class="filter-button current-filter">RINGS</a>
        ...
        <div class="jewelry-grid">
            <div class="jewelry-card" data-name="Crosstail Ring" data-price="980">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/crosstail.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Crosstail Ring</h3>
                    <p class="item-price">USD 980</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Forever Ring" data-price="1150">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/forever.jpg" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Hearts Forever Ring</h3>
                    <p class="item-price">USD 1,150</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
            
            <div class="jewelry-card" data-name="Sterling Ring" data-price="650">
                <a href="#" class="item-link">
                    <div class="item-image"> 
                        <img src="pictures/sterling.webp" alt="Example Image" style=" height: 350px; width: 398px;">
                    </div>
                    <h3 class="item-name">Chrome Heart Sterling Ring</h3>
                    <p class="item-price">USD 650</p>
                </a>
                <button class="add-to-cart-button" onclick="addToCart(this)">ADD TO CART</button>
            </div>
        </div>
